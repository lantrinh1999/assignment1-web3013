              ...
              <div class="box-body">
                <table class="table table-bordered border-secondary">
                    <tr>
                        ...
                        <th>Category Name</th>
                        <th>
                            <a class="btn btn-xs btn-success" href="<?= $baseUrl . "product-add" ?>">
                                Thêm mới
                            </a>
                        </th>
                    </tr>
                    <?php foreach($products as $item) :?>
                        <tr>
                            ...
                            <td>
                                <span class="">
                                    <a class="btn btn-xs btn-info" href="<?= $baseUrl . "product-edit?id=" . $item->id?>">Sửa</a>
                                </span>

                                <span>
                                    <a class="btn btn-xs btn-danger btn-remove" href="<?= $baseUrl . "product-remove?id=" . $item->id?>">Xóa</a>                        
                                </span>
                            </td>
