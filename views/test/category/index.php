...
<section class="content">
    ...
    <table class="table table-bordered border-secondary">
        <tr>
            ...
            <th>Category Name</th>
            <th>
                <a class="btn btn-xs btn-success" href="<?= $baseUrl . "category-add" ?>">
                    Thêm mới
                </a>
            </th>
        </tr>
        <?php foreach($categories as $item) :?>
            <tr>
                ...
                <td>
                    <span class="">
                        <a class="btn btn-xs btn-info" href="<?= $baseUrl . "category-edit?id=" . $item->id?>">Sửa</a>
                    </span>

                    <span>
                        <a class="btn btn-xs btn-danger btn-remove" href="<?= $baseUrl . "category-remove?id=" . $item->id?>">Xóa</a>                        
                    </span>
                </td>
