...
<section class="content">
    ...
    <table class="table table-bordered border-secondary">
        <tr>
            ...
            <th>Role</th>
            <th>
                <a class="btn btn-xs btn-success" href="<?= $baseUrl . "user-add" ?>">
                    Thêm mới
                </a>
            </th>
        </tr>
        <?php foreach($users as $item) :?>
            <tr>
                ...
                <td>
                    <span class="">
                        <a class="btn btn-xs btn-info" href="<?= $baseUrl . "user-edit?id=" . $item->id?>">Sửa</a>
                    </span>

                    <span>
                        <a class="btn btn-xs btn-danger btn-remove" href="<?= $baseUrl . "user-remove?id=" . $item->id?>">Xóa</a>                        
                    </span>
                </td>
